...
public class qs_typeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "qs::qs_type";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final qs_typeTypeSupport _singleton
    = new qs_typeTypeSupport();
    ...
    */
    public static qs_typeTypeSupport get_instance() {
        return _singleton;
    }

    public static qs_typeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return qs_typeTypeCode.VALUE;
    }

    public Object create_data() {
        return qs_type.create();
    }
    ...
    * <code>this</code> is not a <code>qs_type</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        qs_type typedDst = (qs_type) destination;
        qs_type typedSrc = (qs_type) source;
        ...
        Object sample) 
    {
        ...
        qs_type typedSrc = (qs_type) sample;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.value1);

            dst.writeBoolean(typedSrc.condition1);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            qs_type typedDst = (qs_type) dst;
            typedDst.clear();      
            try{
                typedDst.id = src.readInt();
                typedDst.value1 = src.readInt();
                typedDst.condition1 = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            qs_type typedDst = (qs_type) sample;
    ...
    int mask) {
        return new qs_typeDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new qs_typeDataReader(native_reader, listener, mask, this);   
    ...
    protected qs_typeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,qs_typeTypeCode.VALUE,qs_type.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected qs_typeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,qs_typeTypeCode.VALUE,qs_type.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
